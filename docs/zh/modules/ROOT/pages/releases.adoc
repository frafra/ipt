...
====
The current, stable release is version <<2-5-4-december-2021,2.5.4>>.
...
* https://repository.gbif.org/content/groups/gbif/org/gbif/ipt/2.5.4/ipt-2.5.4.war[Download WAR], xref:installation.adoc#installation-from-linux-packages[Linux packages] or xref:installation.adoc#installation-from-docker[use Docker]
