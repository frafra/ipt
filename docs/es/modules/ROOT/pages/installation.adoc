...
El IPT ha sido probado y funciona bien con versiones recientes de Tomcat 7, 8 o 9. La documentación de Apache Tomcat se puede encontrar en http://tomcat.apache.org/.
...
_Como una guía muy aproximada, en CentOS, para ejecutar una sola instancia del IPT:_
